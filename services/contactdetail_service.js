...
export const ContactDetailService = {
    ...
    getContactDetailById: async (id) => {
      try {
        return await prisma.contactDetail.findUnique({ where: { id } });
      } catch (error) {
    ...
    updateContactDetail: async (id, data) => {
      try {
        return await prisma.contactDetail.update({ where: { id }, data });
      } catch (error) {
    ...
    deleteContactDetail: async (id) => {
      try {
        return await prisma.contactDetail.delete({ where: { id } });
      } catch (error) {
